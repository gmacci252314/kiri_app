    ...
    def tela_kiriri():
        return ft.Column(
            [
                ...
                ft.Text("DANTAS, Beatriz G.; SAMPAIO, José Augusto L.; CARVALHO, Maria Rosário G. de. Os povos indígenas no Nordeste brasileiro: um esboço histórico. In: CUNHA, Manuela Carneiro da (org.). História dos índios no Brasil. São Paulo: Companhia das Letras, Secretaria Municipal de Cultura, FAPESP, 1992, pp. 431-456." \
    ...
    def tela_projeto():
        return ft.Column(
            [
                ...
                ft.Text("O Aplicativo Kiri é uma ferramenta tecnológica concebida como parte do projeto de " \
